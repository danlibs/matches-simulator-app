package com.danlibs.soccersimulator.ui.adapter;
...
import com.danlibs.soccersimulator.databinding.MatchItemBinding;
import com.danlibs.soccersimulator.domain.Match;
import com.danlibs.soccersimulator.ui.DetailActivity;
...
public class MatchesAdapter extends RecyclerView.Adapter<MatchesAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        // Adapt the data of the matches (recovered from the API) to the layout
